        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            widget.verify! ? Column(children: [
              ...
              Text('otp_verification'.tr, style: PoppinsBold, textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),

              Text('enter_otp_number'.tr, style: PoppinsRegular.copyWith(color: Theme.of(context).disabledColor), textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),
              ...
              Text('collect_otp_from_customer'.tr, style: PoppinsRegular, textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text(
                  ...
                  style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
                ),
              ]),
