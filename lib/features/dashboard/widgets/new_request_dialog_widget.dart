        ...
        child: GetBuilder<OrderController>(builder: (orderController) {
          return Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            orderController.orderDetailsModel != null ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text('with'.tr , textAlign: TextAlign.center, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
              Text(
                ' ${orderController.orderDetailsModel != null ? orderController.orderDetailsModel!.length.toString() : 0} ',
                textAlign: TextAlign.center, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
              ),
              Text('items'.tr, textAlign: TextAlign.center, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
            ]) : const SizedBox(),
            ...
            orderController.orderDetailsModel != null ? ListView.builder(
              ...
              itemBuilder: (context,index){
                return Padding(
                  ...
                  child: Row(children: [
                    Text('${'item'.tr} ${index + 1}: ', style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                    Flexible(child: Text(
                        '${orderController.orderDetailsModel![index].itemDetails!.name!} ( x ${orderController.orderDetailsModel![index].quantity})',
                        maxLines: 2, overflow: TextOverflow.ellipsis, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                    ),
                  ]),
                );
              },
